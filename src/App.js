...
export default function App() {
  // board is an array, setboard is used to change the state of board
                  ...
                  <Draggable
                    ...
                    onStop={(e) => {
                      ...
                      for (let i = 0; i < allLists.length; i++) {
                        let list = allLists[i];
                        // .getBoundingClientRect is The returned value is a DOMRect object which is the smallest rectangle which contains the entire element, including its padding and border-width
